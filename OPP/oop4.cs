...
namespace ConsoleApp1
{
    ...
    class nhanvien {
        ...
        public void chuan_hoa()
        {
            ...
            // chuan hoa ten
            this.name = System.Threading.Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(this.name.ToLower()); this.name = System.Threading.Thread.CurrentThread.TextInfo.ToTitleCase(this.name.ToLower());
        }
